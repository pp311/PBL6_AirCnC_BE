...
public static class SeedData
{
                                             ...
                                             List<User> users)
    {
        return new Faker<Booking>()
            ...
            .RuleFor(b => b.CheckInDate, f => f.Date.Between(DateTime.UtcNow.AddYears(-1), DateTime.UtcNow.AddYears(1)).Date)
            .RuleFor(b => b.CheckOutDate, (f, b) => b.CheckInDate.AddDays(f.Random.Number(1, 10)).Date)
            .RuleFor(b => b.TotalPrice, (_, b) => b.PricePerNight * (b.CheckOutDate - b.CheckInDate).Days + b.CleaningFee + b.SystemFee)
